...
The [`patterns`](https://github.com/rajanbor/map/tree/main/library) repository is the human
...
[`patterns/docs/specs/registry.md`](https://github.com/rajanbor/map/blob/main/library/docs/specs/registry.md).
