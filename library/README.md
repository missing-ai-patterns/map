...
the CLI's [vision document](https://github.com/rajanbor/map/blob/main/tooling/docs/vision.md),
...
- **Code** (`reference/`, `examples/`, `scripts/`, and the
  [CLI repository](https://github.com/rajanbor/map/tree/main/tooling)) — [MIT](LICENSE). Use,
