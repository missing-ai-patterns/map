...
| [Deep Research Service](deep-research-service/) | Composing published patterns: orchestrator–worker fan-out over untrusted documents, judged outputs, budgeted follow-up memory |
